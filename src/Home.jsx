        ...
        <div className="home">
            <div className="home_container">
                ...
                <div className="home_row">
                    <Link to="/watches" className="link-tag" style={{ textDecoration:"none", flex:1}}>
                        <TypeOfProd 
                            nameOf="WATCHES"
                            image="https://img.tatacliq.com/images/i12/658Wx734H/MP000000018772101_658Wx734H_202308161557593.jpeg"
                        />
                    </Link>
                    <Link to="/footwear" className="link-tag" style={{ textDecoration:"none", flex:1 }}>
                        <TypeOfProd 
                            nameOf="FOOTWEAR"
                ...
                <div className="home_row">
                    <Link to="/jwells" className="link-tag" style={{ textDecoration:"none", flex:1 }}>
                        <TypeOfProd 
                            nameOf="JWELLS"
                            image="https://img.tatacliq.com/images/i9/658Wx734H/MP000000016431668_658Wx734H_202302080130041.jpeg"
                        />
                    </Link>
                    <Link to="/eyewear" className="link-tag" style={{ textDecoration:"none" , flex:1}}>
                        <TypeOfProd 
                            nameOf="EYEWEAR"
                            image="https://img.tatacliq.com/images/i10/658Wx734H/MP000000014109370_658Wx734H_202302231203092.jpeg"
                        />
                    </Link>  
                    <Link to="/perfumes" className="link-tag" style={{ textDecoration:"none" , flex:1}}>
                        <TypeOfProd 
                            nameOf="PERFUMES"
                ...
                <div className="home_row">
                    <Link to="/clothing" className="link-tag" style={{ textDecoration:"none", flex:1 }}>
                        <TypeOfProd 
                            nameOf="CLOTHING"
